...
Contributors: vberkel, milanmk, schemaappnick
...
- Security fix, Address vulnerabilities related to improper sanitization and escaping in admin notices and settings pages

- Fix, Do not use translate option in get_plugin_data when initializing the plugin

= 2.2.4 =
Release Date - 02 Oct 2024
- Fix, Do not report for SearchResultsPage markup in routine that sends markup to SchemaApp for paid accounts

= 2.2.3 =
Release Date - 25 July 2024

- Fix, Resolved issue with Editor meta box nonce check showing error when moving posts to or from trash

= 2.2.2 =
Release Date - 16 July 2024

- Fix, Resolved issue with Editor meta box nonce check to only check during save for applicable post types

= 2.2.1 =
Release Date - 27 June 2024

- Fix, Added missing capability checks and nonce checks to limit unauthorized access in SchemaEditor
- Documentation, Updated author information in readme and throughout plugin to reflect current authors
